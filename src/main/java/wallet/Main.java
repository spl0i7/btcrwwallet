...
import wallettemplate.utils.ForkNetParams;
...
public class Main extends Application {
    public static String APP_NAME = "Bitcoin Rework Wallet";

    public static NetworkParameters params = ForkNetParams.get();
    ...
    public class OverlayUI<T> {
        ...
        public void done() {
            ...
            GuiUtils.fadeOutAndRemove(uiStack, ui, stopClickPane);
